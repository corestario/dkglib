...
require (
	...
	github.com/dgamingfoundation/randapp v0.0.0-20190703104225-5b09eaf566dc
...
replace github.com/tendermint/tendermint => github.com/dgamingfoundation/tendermint v0.27.4-0.20190703120825-5513e8769220
